...
public class LocationTracker implements LocationListener {
    ...
    // following two variable stands for two ways to get user location(GPS or network)
    /**
     * is GPS enabled?
     */
    ...
    public Location getLocation() {
        try {
            ...
            if (!mIsGPSEnabled && !mIsNetworkEnabled) {
                ...
                // this method is added after Android MashMallow, need user give you the permission to use current location
                checkLocationPermission();
                // why check network before GPS? Because GPS need data flow....
